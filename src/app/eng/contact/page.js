...
export default function Contact() {
    ...
    const clienList = {
        0: {
            img: '/site3.png',
            h2: 'Joanna Bensari',
            p: "Our task was to create a photographic portfolio, serving as a visual testament to Joanna Bensari's skills and creativity."
        },
        1: {
            img: '/site2.png',
            h2: 'Paweł, Lawyer',
            ...
            <Transition>
                <div id='contact' className='sourceFont'>
                    ...
                    <div className="backbutton">
                        <Link href="/eng/#servicesV2" id='#contact_link'  ><Image src='/rightarrow.png' alt="go back to projects" className='button' width={44} height={44} style={{ rotate: '90deg' }} ></Image></Link>
                    </div>
                    <div className="video_box" >
                                ...
                                (
                                    <>
                                        <motion.form ref={form} key="clientInfo" animate={isPhone ? {} : { opacity: [0, 1] }} transition={firstLoad ? { duration: 1, delay: 2.8 } : { duration: 1, delay: 0.5 }} className="formularz">
                                            ...
                                            <label htmlFor="name" placeholder="Proszę wprowadzić imię">Name <span style={{ fontWeight: 700 }}>*</span> </label>
                                            ...
                                            <label htmlFor="temat">Topic</label>
                                            <textarea ref={temat} type="text" id='temat' htmlFor="message" name='Nazwafirmy' autoComplete="off" placeholder="website reconstruction" required />


                                            <button className='stylized-button' type='submit' onClick={sendEmail}> Send</button>
                                            <Link href='/eng/privatepolicy'><div className="polityka">*By submitting the form, you <span>accept the privacy policy.</span></div></Link>
                                            <div className="phonediv">
                                                <a href='mailto:home@attadesign.pl'><div className="polityka">our e-mail <span> home@attadesign.pl </span></div></a>
                                                <a href='tel:+48531436420'><div>Phone <span > +48 531&nbsp;436&nbsp;420</span></div></a>
                        ...
                        <div className="leftside">
                            <div className="text_box2">
                                <motion.h1 animate={{ opacity: [0, 1], scale: [0, 1] }} transition={{ duration: 1, delay: 2, type: 'spring' }}>Contact</motion.h1>
                                <motion.p animate={{ opacity: [0, 1], scale: [0, 1] }} transition={{ duration: 1, delay: 2, type: 'spring' }}>Use the form or contact us personally!</motion.p>
                            </div>
                            <div className="contact">
                                ...
                                <motion.div animate={{ opacity: [0, 1], scale: [0, 1] }} transition={{ duration: 1, delay: 2.4, type: 'spring' }} className="rowholder"> <p> ul. Szlenkierów 2/U3, 01-181 Warsaw</p><span><Image src='/locationicon2.png' alt="location icon" width={36} height={36} /></span></motion.div>
                            </div>
