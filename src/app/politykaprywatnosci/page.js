        ...
        <>
            <div className='wrap'>
                ...
                <div className='pp'>
                    ...
                    <br></br> <br></br>
                    <span style={{ fontWeight: '700' }}>Cele przyjętej polityki prywatności i wykorzystywania plików cookies w serwisie internetowym.</span> <br></br>
                    1.1. Niniejsza Polityka prywatności i wykorzystywania plików cookies reguluje zasady przetwarzania danych osobowych zbierania i wykorzystywania informacji o użytkownikach w serwisie internetowym w domenie www.attadesign.pl (zwanych dalej: „Serwisem”). Została stworzona i przyjęta przez ABC ASIA BENSARI CONSULTING - JOANNA BENSARI. Administratorem danych osobowych jest ABC ASIA BENSARI CONSULTING - JOANNA BENSARI.
                    <br></br>
                    Administrator przetwarza Państwa dane osobowe w następujących celach:
                    <br></br>
                    realizacji zleceń i zamówień realizowanych przez podmiot, <br></br>
                    realizacji obowiązków prawnych ciążących na podmiocie, <br></br>
                    komunikacji związanej z obsługą pytań, zleceń i zamówień, oferowanych przez podmiot (kontakt telefoniczny, mailowy, formularz kontaktowy naszego serwisu itp.),
                    <br></br>przy obsłudze reklamacji lub ewentualnych innych roszczeń, <br></br>
                    w celach analitycznych lub statystycznych, <br></br>
                    ...
                    <span style={{ fontWeight: '700' }}>Dane zbierane o użytkownikach w serwisie, w tym dane osobowe sposób ich wykorzystywania, uprawnienia Użytkownika <br></br>
                        Odwiedzając nasz Serwis dane o użytkowniku, mogą być przez niego udostępniane na dwa sposoby: biernie i aktywnie. <br></br></span>
                    ...
                    <br></br>
                    2.3. Użytkownik w każdym czasie ma prawo wglądu do przetwarzanych przez Administratora danych, prawo żądania ich zmiany, a także ich usunięcia. W tym celu należy przesłać wniosek na adres kontakt@attadesign.pl.
                    <br></br>
                    <br></br>
                    Pliki Cookies i sposób ich wykorzystywania
                    Podczas korzystania z Serwisu na urządzeniu końcowym Użytkownika zapisywane są pliki cookies. Nasza polityka cookies jest dostępna pod adresem: www.attadesign.pl/cookies
                    <br></br>
                    Zabezpieczenia
                    ...
                    Zgłoszenia wszelkich nieprawidłowości, uwag, żądań w zakresie polityki prywatności prosimy dokonywać na adres: kontakt@attadesign.pl. Zapewniamy, że każde zgłoszenie będzie przez nas rozpatrzone i udzielimy na nie odpowiedzi na podany w zgłoszeniu adres poczty elektronicznej.
