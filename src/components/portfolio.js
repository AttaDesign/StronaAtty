    ...
    return (
        <div className='portfolio' id="portfolio">
            ...
            <div className={hidden ? 'listing' : 'listing show'}>
                <Case link="https://attadesign-test1.pl/" title="Kancelaria prawna" alt="Strona kancelarii prawnej" h3="Strona z sklepem umów dla Kancelarii prawnej [w budowie]" p="Wykonaliśmy sesję fotograficzną, redesign strony, przeprowadziliśmy cykl konsultacji oraz wdrożyliśmy projekt na serwer testowy. Projekt obecnie oczekuje na docelowe treści oraz finalizację." img="/kuc.png"></Case>
                <Case link="https://zembrzuski.eu/" title="Tadeusz Zembrzuski" alt="Strona zembrzuski.eu" h3="Strona prof. UW dr. hab. Tadeusza Zembrzuskiego" p=" Przeprowadziliśmy migrację oraz odświeżenie designu z zachowaniem ponad 800 wpisów oraz całej struktury linków SEO. Wprowadziliśmy wielo języczność, archiwum wpisów oraz wiele nowoczesnych funkcji" img="/zembrzuski.png"></Case>
